...
(function( $ ){
    ...
    quark.core = {
         ...
         * 
         * TODO : 
         *   Now deplicated interceptor setting.
         *     
         */
        intercept : function( callName, func ){
            if( func ) {
                interceptor[ callName ] = func;
            } else if( interceptor[ callName ] ) {
                var func = interceptor[ callName ];
                interceptor[ callName ] = false;
                func();
            }
        }
    };
